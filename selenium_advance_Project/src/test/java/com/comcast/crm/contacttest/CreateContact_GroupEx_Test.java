...
public class CreateContact_GroupEx_Test extends BaseClass {
	...
	public void createContactTest() throws Throwable {
		...
		String actHearder = driver.findElement(By.className("dvHeaderText")).getText();
		if (actHearder.equals(lastName)) {
